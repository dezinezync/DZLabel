...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.dzlabel.js')
	...
	f = os.path.join(cwd,'Classes','ComDzlabelModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.dzlabel.js']
